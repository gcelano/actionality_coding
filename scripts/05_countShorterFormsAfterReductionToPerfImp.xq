...
{
let $f1 := $c//value[@label="Perf"]/verb_form
let $f2 := $c//value[@label="Imp"]/verb_form
where
$f1 = $f2
return
...
for $ee in collection("/Users/mycomputer/Documents/actionality_coding_DFG/03_p-valuesAfterReductionToPerfImp/documents")
