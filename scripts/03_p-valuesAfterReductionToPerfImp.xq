...
for $t in (db:open("02_aspectOppositions_reduced_to_Perf_Imp")//text)
return

  copy $e := $t
  modify (
    
    replace value of node $e/@xquery with "03_p-valuesAfterReductionToPerfImp.xq",
...
file:write("/Users/mycomputer/Documents/actionality_coding_DFG/03_p-valuesAfterReductionToPerfImp/" || 
